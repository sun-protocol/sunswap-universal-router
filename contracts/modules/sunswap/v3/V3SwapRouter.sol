...
import {ISunSwapV3Pool} from "./interfaces/ISunSwapV3Pool.sol";
import {ISunSwapV3SwapCallback} from "./interfaces/ISunSwapV3SwapCallback.sol";
...
/// @title Router for SunSwap v3 Trades
abstract contract V3SwapRouter is RouterImmutables, Permit2Payments, ISunSwapV3SwapCallback {
    ...
    /// @notice Performs a SunSwap v3 exact input swap
    ...
    /// @notice Performs a SunSwap v3 exact output swap
    /// @param recipient The recipient of the output tokens
