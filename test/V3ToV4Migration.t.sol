...
import {ISunSwapV3PoolDeployer} from "src/modules/sunswap/v3/interfaces/ISunSwapV3PoolDeployer.sol";
import {ISunSwapV3Factory} from "src/modules/sunswap/v3/interfaces/ISunSwapV3Factory.sol";
...
contract V3ToV4MigrationTest is BaseSunSwapV4, OldVersionHelper {
    ...
    function setUp() public {
        ...
        ISunSwapV3LikePairFactory v3Factory = ISunSwapV3LikePairFactory(
    ...
    //             V3ToV4Migrator.InvalidAction.selector, IV3NonfungiblePositionManager.mint.selector
    //         )
    //     );
    //     router.execute(commands, inputs);
    // }
    ...
    ///      then add liquidity to v4nity cl and sweep remaining token
    ...
    function _getErc721PermitSignature(
        address spender,
        uint256 tokenId,
        uint256 deadline
    )
