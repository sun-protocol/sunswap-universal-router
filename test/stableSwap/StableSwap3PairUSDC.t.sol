...
contract StableSwap3PairUSDCTest is Test,DeployPermit2 {
    ...
    function setUp() public {
        ...
        tokens[2] = token2;
        flag = new uint256[](1);
        flag[0] = 0x11001; // 2 is the flag to indicate Stable
        ...
        //     address LPContract;
        // }
        IStableSwapFactory(stableInfo).setStableSwapThreePoolPairInfo(0x11001,address(stablepool), token0, token1, token2, address(0));
