...
import {ICLRouterBase} from "v4-periphery/src/pool-cl/interfaces/ICLRouterBase.sol";
...
import {BaseSunSwapV4} from "./BaseSunSwapV4.sol";
...
/// @dev similar to CLSunSwapV4, except focus on native ETH transfers
contract CLNativeSunSwapV4Test is BaseSunSwapV4 {
    ...
    function test_v4ClSwap_ExactInSingle_NativeIn() public {
        ...
        router.execute{value: amountIn}(commands, inputs, block.timestamp + 100);
    ...
    // @notice not supported now as router is the receipient
