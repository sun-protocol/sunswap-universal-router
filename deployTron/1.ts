module.exports = async ({ getNamedAccounts, deployments, getChainId, getUnnamedAccounts }) => {
  ...
  const params = {
    ...
    stableFactory: '0x9F65BBF7E27C7CC0368C2CF24C9A4868036D8237',
    // stableInfo: '0x9F65BBF7E27C7CC0368C2CF24C9A4868036D8237',
    ...
    safeVault: '0x41F7DF14E436A6EDB1AE17876BF6AA643AE6D120',
  }
